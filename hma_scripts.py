...
tm_move_list = [
    "FIRE PUNCH", "DRAGON CLAW", "WATER PULSE", "CALM MIND", "ROAR", "TOXIC", "HAIL", "BULK UP", 
    "LEAF BLADE", "HIDDEN POWER", "SUNNY DAY", "TAUNT", "ICE BEAM", "BLIZZARD", "HYPER BEAM", 
    ...
    "FIRE BLAST", "ROCK TOMB", "AERIAL ACE", "TORMENT", "FACADE", "POISON FANG", "REST", "ATTRACT", 
    "THIEF", "ICE PUNCH", "SIGNAL BEAM", "THUNDERPUNCH", "OVERHEAT", "CUT", "FLY", "SURF", "STRENGTH", 
    "FLASH", "ROCK SMASH", "WATERFALL", "SECRET POWER"
]
